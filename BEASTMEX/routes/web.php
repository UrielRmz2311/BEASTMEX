...
Route::get('/CPAA', [Controlador::class, 'ConsultaProduAA'])->name('CPAA');
...
Route::get('/RPA', [Controlador::class, 'mostrarFormularioProd'])->name('formularioProd');
...
Route::post('/rulesFormRegisProdu', [Controlador::class,'rulesFormRegisProdu'])->name('rulesFormRegisProd');
...
Route::post('/guardarPr', [Controlador::class,'guardarPr'])->name('rulesModalAgrePro');

Route::post('/modificarPr', [Controlador::class,'modificarPr'])->name('rulesModalModiPro');

Route::post('/EliminarPr',[Controlador::class,'EliminarPr'])->name('eliminarP');
...
Route::get('/inialmacen', [Controlador::class,'metodoinialmacen']);
